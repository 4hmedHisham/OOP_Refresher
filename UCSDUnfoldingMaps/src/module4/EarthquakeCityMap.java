...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		for (Marker country : countryMarkers)//looping over all city markers
		{
			int countrycounter=0;
				...
				{
				EarthquakeMarker eq_marker=(EarthquakeMarker)quake;
					if(eq_marker.isOnLand())
					{
						countryname=(String)country.getProperty("name");
						EarthQuate=(String)quake.getProperty("country");
						if (countryname.equals(EarthQuate))
						{
							countrycounter++;
						}
...
//			}
			...
			if(countrycounter>0)
			System.out.println("Quakes count of "+countryname+" is "+countrycounter );
			else {
				//System.out.println("No Quakes in "+CityName );
			}
